...
export function AppProvider({ children }) {
  ...
  // ─── LOAD SALES (real data only, no mocks) ───
  ...
  const handleCreateSale = async (saleData) => {
    ...
    const { error } = await supabase.from("sales").insert({
      user_id: user.id, title: saleData.title, description: saleData.description,
      address: saleData.address, date_display: saleData.date, date_raw: saleData.dateRaw || null,
      start_time: saleData.startTime || null, end_time: saleData.endTime || null,
      tags: saleData.tags, photos: photoUrls, featured_items: saleData.featuredItems || [],
      lat: saleData.coords.lat, lng: saleData.coords.lng,
