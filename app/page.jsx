...
export default function HomePage() {
  const { activeSales, upcomingSales, loc, dist, unit, sortBy, setSortBy, authLoading, sales } = useApp();

  const useKm = unit === "km";

  // Add distance to active + upcoming sales (past sales excluded from public feed)
  ...
  // Upcoming always sorted by date
